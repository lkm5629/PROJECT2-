...
<body>
	...
	<div class="layout_snb">
		...
		<div class="content">
				...
				<div class="modal_popup">
					...
					<div class="modal_form_row">
						<div class="modal_form_group">
							<label>거래처 명</label> <input class="vendor_info" type="text"
								placeholder="OO부직포">
						</div>

						<div class="modal_form_group">
							<label>담당자 명</label> <input class="vendor_info" type="text"
								placeholder="김OO">
						</div>

						<div class="modal_form_group">
							<label>유형</label> <select class="vendor_info">
								<option>공급업체</option>
								<option>고객사</option>
							</select>
						</div>
					...
					<div class="modal_form_row">
						<div class="modal_form_group">
							<label>연락처</label> <input class="vendor_info" type="text"
								placeholder="041-1234-1234">
						</div>

						<div class="modal_form_group">
							<label>주소</label> <input class="vendor_info" type="text"
								placeholder="충청남도 천안시">
						</div>
					</div>
				...
				<div class="add_vendor_modal_popup">
					...
					<div class="add_modal_form_row">
						<div class="add_modal_form_group">
							<label>거래처 명</label> <input class="add_vendor_info" type="text"
								placeholder="거래처명을 입력하세요">
						</div>

						<div class="add_modal_form_group">
							<label>담당자 명</label> <input class="add_vendor_info" type="text"
								placeholder="담당자명을 입력하세요">
						</div>

						<div class="add_modal_form_group">
							<label>유형</label> <select class="add_vendor_info">
								<option>공급업체</option>
								<option>고객사</option>
							</select>
						</div>
					...
					<div class="add_modal_form_row">
						<div class="add_modal_form_group">
							<label>연락처</label> <input class="add_vendor_info" type="text"
								placeholder="연락처를 입력하세요">
						</div>

						<div class="add_modal_form_group">
							<label>주소</label> <input class="add_vendor_info" type="text"
				...
				<div class="edit_vendor_modal_popup">
					...
					<div class="edit_modal_form_row">
						<div class="edit_modal_form_group">
							<label>거래처 명</label> <input class="edit_vendor_info" type="text"
								value="OO부직포">
						</div>

						<div class="edit_modal_form_group">
							<label>담당자 명</label> <input class="edit_vendor_info" type="text"
								value="김OO">
						</div>

						<div class="edit_modal_form_group">
							<label>유형</label> <select class="edit_vendor_info">
					...
					<div class="edit_modal_form_row">
						<div class="edit_modal_form_group">
							<label>연락처</label> <input class="edit_vendor_info" type="text"
								value="041-1234-1234">
						</div>

						<div class="edit_modal_form_group">
							<label>주소</label> <input class="edit_vendor_info" type="text"
								value="충청남도 천안시">
						</div>
					</div>
					...
					<div class="edit_vendor_btn_area">
						...
						<button type="button" class="edit_vendor_save_btn">수정</button>
					</div>
				</div>
			</div>
			<!-- 거래처 수정 모달 -->
			...
			<script src="../js/vendor_management.js"></script>
		</div>
	</div>
