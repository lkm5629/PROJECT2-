...
<script src="/mes/static/js/08_quality/add.js"></script>
...
<body>
    ...
    <div class="layout_snb">
        ...
        <div class="content">
        	<!-- 상단 -->
			<form method="post" action="/mes/qcadd">
				<div class="page-header">
					<div>
						<h2>검사계획 등록</h2>
						<p class="sub-text">완료된 작업에 대하여 검사계획을 등록하세요.</p>
					</div>
				...
				<div class="card">
					...
					<div class="form-grid">
						...
						<div class="form-group full">
							<label>완료된 작업</label>
							<div>
								<select class="workSel" id="workSelect" name="workSelect">
									<option value="" disabled selected>완료된 작업 선택</option>
									<c:forEach var="work" items="${woList}">
						...
						<div class="form-group">
							...
							<input type="text" id="item" placeholder="제품명 (제품 코드)" readonly>
						</div>

						<!-- 검사 수량 -->
						<div class="form-group">
							<label>검사 수량</label>
							<input type="text" id="qty" placeholder="검사 예정 수량" readonly>
						</div>
						
						<!-- 검사 시작일 -->
						<div class="form-group">
							<label>검사 시작일</label>
							<input type="date" id="qcDate" name="qcDate">
						</div>
